...
<div class="p-6 md:p-10 max-w-4xl mx-auto font-['Inter',sans-serif] text-slate-800 antialiased">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Perbarui nama dan deskripsi detail mengenai organisasi ini.
            </p>
        </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-100/80 p-6 md:p-8">
        ...
        <form action="{{ route('admin.organizations.update',$organization->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">
                    Nama Organization <span class="text-rose-500">*</span>
                </label>
            ...
            <div>
                ...
                <textarea
                    name="description"
                    rows="4"
                    class="w-full bg-slate-50/80 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition duration-150 resize-y"
                    placeholder="Tuliskan deskripsi ringkas organisasi...">{{ $organization->description }}</textarea>
            </div>
